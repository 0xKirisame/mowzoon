...
// accumulates healthy behaviour and powers the wheel). This is the competitive
...
//
// Only ranked matches (ghost / trade — real opponents) call this; single-player
// vs CPU is practice and leaves rank untouched, so the enemy roster can't farm.
